/*
 * $Id: FilterDispatcher.java,v 1.3 2011/03/08 06:48:48 cvs_ningcl Exp $
 *
...
import org.xz.qstruts.utils.ResponseUtils;
 ...
 * the subclass.
 *
 * @version $Date: 2011/03/08 06:48:48 $ $Id: FilterDispatcher.java,v 1.3 2011/03/08 06:48:48 cvs_ningcl Exp $
...
public class FilterDispatcher implements StrutsStatics, Filter {
    ...
    public void doFilter(ServletRequest req, ServletResponse res, FilterChain chain) throws IOException, ServletException {
        ...
        try {
            ...
            ModuleResponse actionresponse = new ModuleResponse(response);
            dispatcher.serviceAction(request, actionresponse, servletContext, mapping);
            ResponseUtils.copyResponse(response, actionresponse);
        } finally {
            try {
