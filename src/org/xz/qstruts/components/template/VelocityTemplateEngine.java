/*
 * $Id: VelocityTemplateEngine.java,v 1.4 2011/04/11 02:46:55 cvs_ningcl Exp $
 *
...
public class VelocityTemplateEngine extends BaseTemplateEngine {
    ...
    public void renderTemplate(TemplateRenderingContext templateContext) throws Exception {
        ...
        Context context = velocityManager.createContext((ActionContext)templateContext.getStack().findValue(ActionContext.ACTIONCONTEXT), req, res);
        
        Writer outputWriter = templateContext.getWriter();
        context.put(templateContext.getTag().getComponentName(), templateContext.getTag());
