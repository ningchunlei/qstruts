/*
 * $Id: VelocityManager.java,v 1.3 2011/03/25 10:23:57 cvs_ningcl Exp $
 *
...
import org.xz.qstruts.views.utils.ContextUtil;
...
public class VelocityManager {
     ...
     */
    public Context createContext(ActionContext ac,HttpServletRequest req, HttpServletResponse res) {
        Context result = null;
        StrutsVelocityContext context = new StrutsVelocityContext(req);
        Map standardMap = ContextUtil.getStandardContext(ac, req, res);
        ...
        try {
            ...
            context.put("ctx", ctx.getServletContextName());
