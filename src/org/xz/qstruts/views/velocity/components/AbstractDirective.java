/*
 * $Id: AbstractDirective.java,v 1.7 2011/04/01 02:39:38 cvs_ningcl Exp $
 *
...
public abstract class AbstractDirective extends Directive {
    public static final String INTERNALCONTEXT = "InternalContext"; 
	
	public String getName() {
        return "q" + getBeanName();
    }
    ...
    public boolean render(InternalContextAdapter ctx, Writer writer, Node node) throws IOException, ResourceNotFoundException, ParseErrorException, MethodInvocationException {
        // get the bean
        ValueStack stack = (ValueStack) ctx.get(ContextUtil.STACK);
        Component bean = getBean(stack);
        Container container = (Container) stack.getContext().get(ActionContext.CONTAINER);
        container.inject(bean);
        // get the parameters
        Map params = createPropertyMap(ctx, node);
        params.put(INTERNALCONTEXT, ctx);
