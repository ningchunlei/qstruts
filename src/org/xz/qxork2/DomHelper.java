...
public class DomHelper {
    ...
    public static Document parse(InputSource inputSource, boolean validating) {
        ...
        try {
             ...
             Schema schema = sf.newSchema(new StreamSource(ClassLoaderUtil.getResourceAsStream("autofill.xsd", DomHelper.class)));
        ...
        try {
            parser.parse(inputSource, new StartHandler(locationHandler, null));
        } catch (Exception ex) {
